      ...
      <div className="flex-1 flex flex-col sm:flex-row gap-6 h-full min-h-0">
        ...
        <div className="flex-1 flex flex-col bg-surface border border-border rounded-2xl shadow-sm overflow-hidden min-h-[50vh]">
          ...
          <div className="flex items-center gap-1 px-6 py-2 border-y border-border bg-background/50 overflow-x-auto">
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Bold">
              <span className="font-bold font-serif px-1">B</span>
            </button>
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Italic">
              <span className="italic font-serif px-1">I</span>
            </button>
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Underline">
              <span className="underline font-serif px-1">U</span>
            </button>
            <span className="w-px h-6 bg-border mx-2"></span>
            
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Heading 1">
              <span className="font-bold text-sm">H1</span>
            </button>
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Heading 2">
              <span className="font-bold text-sm">H2</span>
            </button>
            <span className="w-px h-6 bg-border mx-2"></span>

            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Link">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
              </svg>
            </button>
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Image">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </button>
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Code Block">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
              </svg>
            </button>
            <button className="p-2 rounded hover:bg-surface hover:text-primary transition-colors text-foreground opacity-70 hover:opacity-100 flex-shrink-0" title="Quote">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
